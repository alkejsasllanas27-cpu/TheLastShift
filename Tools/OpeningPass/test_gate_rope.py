...
cases=[(-13600,2242,1342,1,300,-10450),(-10450,2242,1342,-1,300,-13600),(-13600,2242,1342,1,600,-10450),(-10450,2242,1342,-1,600,-13600)]
state={'index':-1,'results':[],'last':time.monotonic()}
def begin():
    state['index']+=1
    if state['index']>=len(cases):
        unreal.unregister_slate_post_tick_callback(state['handle'])
        with open('C:/Users/Admin/TheLastShift/Saved/OpeningPass/gate-rope-test.json','w') as f:json.dump(state['results'],f,indent=2)
